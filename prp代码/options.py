...
def parse_args():
    ...
    parser.add_argument('--label_data_path',
                        type=str,
                        default='F:\\his\\data\\Usable data',
    ...
    parser.add_argument('--follow_up_data',
                        type=str,
                        default='F:\\his\\data\\follow_up_data.txt',
    ...
    parser.add_argument('--split_out_path',
                        type=str,
                        default='./Data2',
                        help='path to save train validation and test graphs')
